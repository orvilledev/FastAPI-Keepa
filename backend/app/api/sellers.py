...
class SellerIdsBulkDelete(BaseModel):
    seller_ids: List[str]
...
async def add_seller_name(
    ...
    """Add a new seller name mapping (MSW Overwatch / Keepa access)."""
    repo = SellerNameRepository(db)
...
async def update_seller_name(
    ...
    """Update a seller name mapping (MSW Overwatch / Keepa access)."""
    repo = SellerNameRepository(db)
...
async def bulk_upsert_seller_names(
    ...
    """Bulk add/update seller name mappings (MSW Overwatch / Keepa access)."""
    repo = SellerNameRepository(db)
...
async def delete_seller_name(
    ...
    """Delete a seller name mapping (MSW Overwatch / Keepa access)."""
    repo = SellerNameRepository(db)
...
async def bulk_delete_seller_names(
    ...
    """Delete multiple seller name mappings (MSW Overwatch / Keepa access)."""
    repo = SellerNameRepository(db)
    count = repo.bulk_delete_seller_names(data.seller_ids)
    return {"message": f"Deleted {count} seller name mapping(s)", "count": count}
