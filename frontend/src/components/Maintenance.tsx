...
const QUIZ_BANK: QuizItem[] = [
  ...
  {
    id: 'q11',
    question: 'When OKC acquired Paul George from Indiana in July 2017, which two players did the Pacers receive?',
    choices: ['Victor Oladipo & Domantas Sabonis', 'Enes Kanter & Doug McDermott', 'Andre Roberson & Jerami Grant', 'Alex Abrines & Patrick Patterson'],
    correctIndex: 0,
    explanation: 'Indiana received Victor Oladipo and Domantas Sabonis — both became All-Stars after the trade.',
  },
  {
    id: 'q12',
    question: 'When OKC traded Russell Westbrook to Houston in July 2019, which star guard did they receive in return?',
    choices: ['James Harden', 'Chris Paul', 'Eric Gordon', 'Clint Capela'],
    correctIndex: 1,
    explanation: 'OKC received Chris Paul along with four first-round picks and four pick swaps.',
  },
  {
    id: 'q13',
    question: 'Australian guard Josh Giddey was selected with which pick in the 2021 NBA Draft?',
    choices: ['3rd overall', '5th overall', '6th overall', '8th overall'],
    correctIndex: 2,
    explanation: 'OKC selected Giddey 6th overall in 2021; he became one of the youngest players to record an NBA triple-double.',
  },
  {
    id: 'q14',
    question: 'OKC selected Jalen Williams with which pick in the 2022 NBA Draft, the same night as Chet Holmgren?',
    choices: ['8th overall', '10th overall', '12th overall', '14th overall'],
    correctIndex: 2,
    explanation: 'Williams fell to #12 despite his talent; he went on to make the All-Star team in his second season.',
  },
  {
    id: 'q15',
    question: 'What is the Oklahoma City Thunder\'s official mascot?',
    choices: ['Boomer the Bull', 'Rumble the Bison', 'Twister the Tornado', 'Sooner the Horse'],
    correctIndex: 1,
    explanation: 'Rumble the Bison has been the Thunder\'s mascot since the franchise relocated to OKC in 2008.',
  },
  {
    id: 'q16',
    question: 'Serge Ibaka was born in the Republic of Congo but represents which country internationally?',
    choices: ['Nigeria', 'DR Congo', 'Republic of Congo', 'Spain'],
    correctIndex: 3,
    explanation: 'Ibaka holds Spanish citizenship and has represented the Spanish national team in international competition.',
  },
  {
    id: 'q17',
    question: 'Kevin Durant left OKC as a free agent in July 2016 to join which team that had just won a record 73 regular-season games?',
    choices: ['Cleveland Cavaliers', 'San Antonio Spurs', 'Golden State Warriors', 'Miami Heat'],
    correctIndex: 2,
    explanation: 'Durant\'s decision to join the 73-win Warriors was one of the most debated moves in NBA history.',
  },
  {
    id: 'q18',
    question: 'Who won Finals MVP when the Miami Heat defeated OKC in the 2012 NBA Finals?',
    choices: ['Dwyane Wade', 'LeBron James', 'Chris Bosh', 'Shane Battier'],
    correctIndex: 1,
    explanation: 'LeBron averaged 28.6 points, 10.2 rebounds, and 7.4 assists per game in that series.',
  },
  {
    id: 'q19',
    question: 'In his emotional 2014 MVP acceptance speech, Kevin Durant called his mother "the real MVP." What is her name?',
    choices: ['Beverly', 'Wanda', 'Barbara', 'Shirley'],
    correctIndex: 1,
    explanation: 'Wanda Durant raised Kevin largely on her own; his tearful tribute to her became one of the most memorable moments in NBA awards history.',
  },
  {
    id: 'q20',
    question: 'What was OKC\'s regular-season win total in 2012–13, the best record in franchise history?',
    choices: ['55 wins', '58 wins', '60 wins', '63 wins'],
    correctIndex: 2,
    explanation: 'The Thunder went 60-22 in 2012–13, the best record in the Western Conference that season.',
  },
]
