...
export default function TrackingScanner() {
  ...
  // Scan lifecycle lives in TrackingScanProvider (above the router) so it
  // survives navigation away from this page. Only pure-UI state stays local.
  const {
    files,
    rows,
    stats,
