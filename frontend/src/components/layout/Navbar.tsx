        ...
        <div className="flex h-20 items-center gap-4">
          ...
          <div className="flex shrink-0 items-center space-x-2 ml-auto">
            ...
            >
              ...
              {unreadCount > 0 && (
                <span className="absolute top-0 right-0 z-10 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full">
